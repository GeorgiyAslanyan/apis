            ...
            <div className='min-h-[60vh] grid-cols-2 grid'>
                <div className='w-full h-full flex flex-col gap-3 items-start justify-center'>
                    ...
                    <div className='flex gap-7'>
                        <a href="http://" target="_blank" rel="noopener noreferrer" className='border-white px-5 py-2 border'>Documentation</a>
                        <a href="http://" target="_blank" rel="noopener noreferrer" className='border-white px-5 py-2 border'>Go to app</a>
                    </div>
                </div>
